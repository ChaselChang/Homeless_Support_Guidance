...
```{r export data}
save(Homebase_Centers,Food_Stamp_Centers,after_school_programs,Health_Insurance,Job_Centers,condom_distribution,radar,Population, file="../app/homeless.RData")
```
